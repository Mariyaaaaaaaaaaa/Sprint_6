...
class OrderPageLocators:
    ...
    # Цвет самоката:
    colour_black = [By.XPATH, "(.//input)[3]"]
    colour_grey = [By.XPATH, "(.//input)[4]"]

    # Комментарий для курьера:
    commentary = [By.XPATH, "(.//input)[5]"]

    # Кнопка Заказать на странице Заказа:
    order_button_order_page = [By.XPATH, "(.//button[text()='Заказать'])[2]"]
    ...
    order_is_completed = [By.XPATH, "//div[contains(@class, 'Order_ModalHeader')]"]
